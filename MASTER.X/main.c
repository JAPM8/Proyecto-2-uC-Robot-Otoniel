 ...
 * interacción con interfaz gráfica a un baud rate de 9600 y generación  de 
 * 2 señales PWM.
 * 
 * 
...
int modo = 0, //Variable que indica estado en que nos encontramos
    ...
    flag_r2 = 0; //Flag para habilitar lectura en EEPROM con botón 2
        ...
        //Variables PWM, guardan valor de potenciómetros
...
void __interrupt() isr(void){
    ...
    if(PIR1bits.RCIF){ //Se verifica si hay un nuevo dato en el serial
        ...
        val_terminal = RCREG; //Se guarda valor obtenido de la interfaz               
    }    
