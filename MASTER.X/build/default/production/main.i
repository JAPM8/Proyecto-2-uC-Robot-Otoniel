...
uint8_t servo1 = 0, servo2 = 0, servo3 = 0, servo4 = 0,
        servo11 = 0, servo22 = 0, servo33 = 0, servo44 = 0,

        val_terminal = 0, flag_terminal = 0, valor_old = 0, indice = 0;

unsigned short CCPR_S1 = 0, CCPR_S2 = 0, CCPR_S3 = 12, CCPR_S4 = 140;


char mensaje[9] = {'M', 'o', 'v', 'e', 'r', ' ', ' ', 0x0D, 0x0A};
    ...
    if (PIR1bits.ADIF){
        if (ADCON0bits.CHS == 0){
            if(modo == 0){
                ...
                CCPR_S1 = map(servo1, 0, 255, 15, 75);
            }
            else if (modo == 1){
                ...
                CCPR_S1 = map(servo11, 0, 31, 15, 75);
            }
            ...
            if(modo == 0){
                ...
                CCPR_S2 = map(servo2, 0, 255, 15, 75);
            }
            else if (modo == 1){
                ...
                CCPR_S2 = map(servo22, 0, 31, 15, 75);
            }
            ...
            if(modo == 0){
                ...
                CCPR_S3 = map(servo3, 0, 255, 15, 75);
            }
            else if (modo == 1){
                ...
                CCPR_S3 = map(servo33, 0, 31, 15, 75);
            }


            CCPR_S3 = CCPR_S3 & 0b01111111;
        }
        else if (ADCON0bits.CHS == 3){
            if(modo == 0){
                servo4 = ADRESH;

                CCPR_S4 = map(servo4, 0, 255, 15, 75);
            }
            else if (modo == 1){
                ...
                CCPR_S4 = map(servo44, 0, 31, 15, 75);
            }


            CCPR_S4 = (CCPR_S4 & 0b01111111) + 128;
        }
        PIR1bits.ADIF = 0;
    }
...
void main(void) {
    ...
    while(1){
        ...
        SSPBUF = (uint8_t) CCPR_S3;
        while(!SSPSTATbits.BF);
        _delay((unsigned long)((2)*(500000/4000.0)));
        SSPBUF = (uint8_t) CCPR_S4;
        while(!SSPSTATbits.BF);
        ...
        flag_terminal = val_terminal & 0b01100000;
        if(flag_terminal == 0){

            servo1 = val_terminal & 0b00011111;
        }
        else if(flag_terminal == 32){

            servo2 = val_terminal & 0b00011111;
        }
        else if(flag_terminal == 64){

            servo3 = val_terminal & 0b00011111;
        }
        else if(flag_terminal == 96){

            servo4 = val_terminal & 0b00011111;
        }
        }
        if(ADCON0bits.GO == 0){
                if(ADCON0bits.CHS == 0)
...
void set_ADC(void) {
    ...
    ADCON1bits.ADFM = 0;
    ADCON0bits.ADON = 1;
    _delay((unsigned long)((420)*(500000/4000000.0)));
